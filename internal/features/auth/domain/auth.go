// Package authdomain contains domain types for the auth feature.
package authdomain
...
// OTPPurpose enumerates the valid purposes for OTP codes.
...
// OTPVerification represents a one-time password verification record.
