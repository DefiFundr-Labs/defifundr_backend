...
func (q *Queries) GetSessionByRefreshToken(ctx context.Context, refreshToken pgtype.Text) (Sessions, error) {
...
func (q *Queries) UpdateRefreshToken(ctx context.Context, arg UpdateRefreshTokenParams) (Sessions, error) {
	row := q.db.QueryRow(ctx, updateRefreshToken, arg.RefreshToken, arg.ID)
	var i Sessions
	err := row.Scan(
		&i.ID,
		&i.UserID,
